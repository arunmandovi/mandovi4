    ...
    public void saveLabourFromExcel(MultipartFile file) {
        try {
            ...
            Set<String> mysoreBranches = new HashSet<>(Arrays.asList(
                    ...
                    "Mandya","Mysore Nexa","Nagamangala","Narasipura","Somvarpet","Kollegal"
            ...
            for(int i=1;i<=sheet.getLastRowNum();i++){
                ...
                switch (month) {
                    case "Apr", "May", "Jun", "APR", "MAY", "JUN" ->{ labour.setQtrWise("Q1"); labour.setHalfYear("H1");}
                    case "Jul", "Aug", "Sep", "JUL", "AUG", "SEP" ->{ labour.setQtrWise("Q2"); labour.setHalfYear("H1");}
                    case "Oct", "Nov", "Dec", "OCT", "NOV", "DEC" ->{ labour.setQtrWise("Q3"); labour.setHalfYear("H2");}
                    case "Jan", "Feb", "Mar", "JAN", "FEB", "MAR" ->{ labour.setQtrWise("Q4"); labour.setHalfYear("H2");}
                }
